...
async function runLoadTest() {
    ...
    const phases = [
        { number: 1, requests: 3, duration: 12000 },  // 2 mins with 3 requests
        { number: 2, requests: 6, duration: 12000 },  // 2 mins with 6 requests
        { number: 3, requests: 9, duration: 12000 }   // 2 mins with 9 requests
    ];
